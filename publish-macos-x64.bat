...
robocopy SQribe/scripts SQribe/bin/Release/net9.0/osx-x64/publish/scripts/ /E
robocopy SQribe/templates SQribe/bin/Release/net9.0/osx-x64/publish/templates /E
