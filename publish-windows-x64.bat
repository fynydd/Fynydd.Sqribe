...
robocopy SQribe/scripts SQribe/bin/Release/net7.0/win-x64/publish/scripts/ /E
robocopy SQribe/templates SQribe/bin/Release/net7.0/win-x64/publish/templates /E
