...
if @FileGroupName is null begin
    ...
    case when len(@IncludedColumns)>0 then CHAR(13) + CHAR(10) +'INCLUDE (' + @IncludedColumns+ ')' else '' end + CHAR(13) + CHAR(10)+'WITH (' + @IndexOptions+ ');' + CHAR(13) + CHAR(10) + 'GO -- SQRIBE/GO' + CHAR(13) + CHAR(10)
