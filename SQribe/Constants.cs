...
public static class Constants
{
	...
	public static ConsoleColor GetColor(string colorName, bool darkMode = true)
	{
		...
		{
			case "success":
				result = (ConsoleColor) Constants.TextColorSuccess[(darkMode ? 0 : 1)];
				break;
			case "prompt":
				result = (ConsoleColor) Constants.TextColorPrompt[(darkMode ? 0 : 1)];
				break;
			case "warning":
				result = (ConsoleColor) Constants.TextColorWarning[(darkMode ? 0 : 1)];
				break;
			case "busy":
				result = (ConsoleColor) Constants.TextColorBusy[(darkMode ? 0 : 1)];
				break;
			case "error":
				result = (ConsoleColor) Constants.TextColorError[(darkMode ? 0 : 1)];
				break;
			default:
				result = (ConsoleColor) Constants.TextColor[(darkMode ? 0 : 1)];
				break;
		}
